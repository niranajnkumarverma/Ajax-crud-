...
def profile_data(request, user_obj = None):
    if user_obj:
        ...
        user_obj = User.objects.get(Email=request.session['email']).__dict__
        default_data['profile_data'] = user_obj
...
def signin_ajax(request):
    ...
    try:
        ...
        if user.Password == password:
            ...
            default_data['url'] = url
            default_data['msgs']['show'] = True
            default_data['msgs']['text'] = 'Your password is incorrect!'
            default_data['msgs']['title'] = 'Wrong'
            default_data['msgs']['type'] = 'Warning'
            return JsonResponse(default_data)
        ...
        print('Error: ', err)
        default_data['msgs']['show'] = True
        default_data['msgs']['text'] = f'{email} doesn\'t exist. please signup first.'
        default_data['url'] = '/signin/'
        default_data['msgs']['title'] = 'Error'
        default_data['msgs']['type'] = 'danger'
        return JsonResponse(default_data)
...
def logout(request):
    if 'email' in request.session:
        ...
        default_data['msgs'] = 'Logged out successfully!'
