...
from .views import change_password, create_todo, delete_todo, otp_page, profile_update, profile_update_page, signin_ajax, update_todo, index, logout, profile_page, register, register_page, signin, signin_page, verify_otp
...
urlpatterns = [
    ...
    path('signin_ajax/', signin_ajax, name='signin_ajax'),
